// ======================================================================
// shutter_controller.v generated from TopDesign.cysch
// 12/19/2019 at 14:50
...
module top ;
	...
	wire [0:0] tmpOE__manual_open_net;
	wire [0:0] tmpIO_0__manual_open_net;
	wire [0:0] tmpINTERRUPT_0__manual_open_net;
	electrical [0:0] tmpSIOVREF__manual_open_net;
	...
	cy_psoc3_pins_v1_10
		...
		manual_open
		 (.oe(tmpOE__manual_open_net),
		  .y({1'b0}),
		  .fb({Net_8}),
		  .io({tmpIO_0__manual_open_net[0:0]}),
		  .siovref(tmpSIOVREF__manual_open_net),
		  .interrupt({tmpINTERRUPT_0__manual_open_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__manual_open_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__digital_control_net;
	wire [0:0] tmpIO_0__digital_control_net;
	wire [0:0] tmpINTERRUPT_0__digital_control_net;
	electrical [0:0] tmpSIOVREF__digital_control_net;

	cy_psoc3_pins_v1_10
		#(.id("ca81a931-cbb8-4ee2-9208-6c373fe51bcb"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		digital_control
		 (.oe(tmpOE__digital_control_net),
		  .y({1'b0}),
		  .fb({Net_2}),
		  .io({tmpIO_0__digital_control_net[0:0]}),
		  .siovref(tmpSIOVREF__digital_control_net),
		  .interrupt({tmpINTERRUPT_0__digital_control_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__digital_control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__manual_close_net;
	wire [0:0] tmpIO_0__manual_close_net;
	wire [0:0] tmpINTERRUPT_0__manual_close_net;
	electrical [0:0] tmpSIOVREF__manual_close_net;

	cy_psoc3_pins_v1_10
		#(.id("1d2dfa2d-b65a-42a4-a514-14cabaf0463b"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		manual_close
		 (.oe(tmpOE__manual_close_net),
		  .y({1'b0}),
		  .fb({Net_80}),
		  .io({tmpIO_0__manual_close_net[0:0]}),
		  .siovref(tmpSIOVREF__manual_close_net),
		  .interrupt({tmpINTERRUPT_0__manual_close_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__manual_close_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_177 = Net_180 & Net_181;
    ...
    // -- SRFF Start --
    reg  cy_srff_2;
    always @(posedge Net_182)
    begin
        cy_srff_2 <= (Net_116 | Net_105) & ~Net_183;
    end
    assign Net_105 = cy_srff_2;
    // -- SRFF End --


    assign Net_79 = ~Net_116;


    assign Net_183 = Net_79 | Net_80;
    ...
    assign Net_181 = ~Net_183;


    assign Net_187 = Net_105 & Net_184;


    assign Net_195 = ~Net_105;


    assign Net_225 = Net_105 ^ Net_184;
