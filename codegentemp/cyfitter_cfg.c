...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT14), 0x00000030u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x00300303u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x0C230000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x02C00000u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT0_BASE), 0x00000025u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00030186u);
	...
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x000180D8u);
